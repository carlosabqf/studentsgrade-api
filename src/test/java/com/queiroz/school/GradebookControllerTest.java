package com.queiroz.school;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.queiroz.school.models.CollegeStudent;
import com.queiroz.school.models.MathGrade;
import com.queiroz.school.repository.HistoryGradesDao;
import com.queiroz.school.repository.MathGradesDao;
import com.queiroz.school.repository.ScienceGradesDao;
import com.queiroz.school.repository.StudentDao;
import com.queiroz.school.service.StudentAndGradeService;
...
public class GradebookControllerTest {
    ...
    public static void setup() {
        ...
        request.setParameter("firstname", "Carlos");

        request.setParameter("lastname", "Queiroz");

        request.setParameter("emailAddress", "Carlos.Queiroz@school.com");
    }
    ...
    public void getStudentsHttpRequest() throws Exception {
        ...
        student.setLastname("Queiroz");
        student.setEmailAddress("Carlos.Queiroz@school.com");
    ...
    public void createStudentHttpRequest() throws Exception {
        student.setFirstname("Carlos");
        student.setLastname("Queiroz");
        student.setEmailAddress("Carlos_Queiroz@school.com");
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("Carlos_Queiroz@school.com");
    ...
    public void studentInformationHttpRequest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/studentInformation/{id}", 1))
                ...
                .andExpect(jsonPath("$.lastname", is("Queiroz")))
                .andExpect(jsonPath("$.emailAddress", is("carlos.queiroz@school.com")));
    }
