...
import com.queiroz.school.models.*;
...
public class StudentAndGradeServiceTest {
    ...
    public void createStudentService() {
        ...
        studentService.createStudent("Carlos", "Queiroz", "Carlos.Queiroz@school.com");

        CollegeStudent student = studentDao.findByEmailAddress("Carlos.Queiroz@school.com");

        assertEquals("Carlos.Queiroz@school.com", student.getEmailAddress(), "find by email");
    }
    ...
    public void studentInformationService() {
        ...
        assertEquals("Carlos", gradebookCollegeStudentTest.getFirstname());
        assertEquals("Queiroz", gradebookCollegeStudentTest.getLastname());
        assertEquals("carlos.queiroz@school.com", gradebookCollegeStudentTest.getEmailAddress());
